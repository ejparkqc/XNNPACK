...
#define DECLARE_PF16_GEMM_MINMAX_UKERNEL_FUNCTION(fn_name)                  \
  ...
  XNN_INTERNAL void fn_name(size_t mr, size_t nc, size_t kc, const void* a, \
                            ...
                            size_t cn_stride,                               \
                            const union xnn_f16_minmax_params               \
...
#define DECLARE_PF32_GEMM_MINMAX_UKERNEL_FUNCTION(fn_name)                  \
  ...
  XNN_INTERNAL void fn_name(size_t mr, size_t nc, size_t kc, const void* a, \
                            ...
                            size_t cn_stride,                               \
                            const union xnn_f32_minmax_params               \
                                params[XNN_RESTRICT XNN_MIN_ELEMENTS(1)]);
...
DECLARE_QS8_QC8W_GEMM_MINMAX_UKERNEL_FUNCTION(xnn_qs8_qc8w_gemm_minmax_fp32_ukernel_1x32c4__hvx)
DECLARE_QS8_QC8W_GEMM_MINMAX_UKERNEL_FUNCTION(xnn_qs8_qc8w_gemm_minmax_fp32_ukernel_4x32c4__hvx)
DECLARE_QS8_QC8W_GEMM_MINMAX_UKERNEL_FUNCTION(xnn_qs8_qc8w_gemm_minmax_fp32_ukernel_8x32c4__hvx)
DECLARE_QS8_QC8W_GEMM_MINMAX_UKERNEL_FUNCTION(xnn_qs8_qc8w_gemm_minmax_fp32_ukernel_16x32c4__hvx)
